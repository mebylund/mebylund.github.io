    ...
    */
    ...
    describe('the menu', function () {
        ...
        it("menu is hidden by defult", function () {
            var clss = ($('body').hasClass('menu-hidden'));
            expect(clss).toBe(true);
        ...
        it('menu changes to correct icon', function () {
            ...
            var clss = ($('body').hasClass('menu-hidden'));
            expect(clss).toBe(false);
            ($('.menu-icon-link').click());
            clss = ($('body').hasClass('menu-hidden'));
            expect(clss).toBe(true);
        });
    ...
    describe('Initial Entries', function () {
         ...
         */
        it('loadFeed is called and completes work', function (done) {
